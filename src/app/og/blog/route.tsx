...
export async function GET(request: Request) {
  try {
    ...
    const title = encodedTitle ? decodeURIComponent(encodedTitle) : "shreyas's blog";
    ...
    try {
      fontData = await loadGoogleFont("Geist+Mono", "shreyas blog tech");
      fontDataBold = await loadGoogleFont("Inter:wght@700", "shreyas blog tech");
    } catch (error) {
      console.error("Font loading error:", error);
      fontData = null;
      fontDataBold = null;
    ...
    return new ImageResponse(
      (
        ...
        >
          <h1 style={{ fontSize: 60, textAlign: "center" }}>shreyas blog</h1>
        </div>
      ),
      {
        width: 1200,
