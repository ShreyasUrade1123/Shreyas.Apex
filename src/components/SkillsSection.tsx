...
const skills: Skill[] = [
  ...
  },
  {
    ...
    name: "Render",
    level: 3,
    logo: "https://upload.wikimedia.org/wikipedia/commons/3/3d/Render_logo.svg",
    color: SKILL_COLORS.react,
    category: "Tools"
  },
  {
  ...
  },
  {
    ...
    name: "Framer",
    level: 4,
    logo: "https://www.svgrepo.com/show/306070/framer.svg",
    color: SKILL_COLORS.react,
    category: "Design"
  },
  {
  ...
  },
  {
    ...
    name: "Django",
    level: 3,
    logo: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/django/django-original.svg",
    color: SKILL_COLORS.react,
    category: "Backend"
  },
];
...
const SkillItem = memo(({ 
  ...
  // Tạo các hạt ngẫu nhiên với useClientParticles
  const particles = useClientParticles(15, (i) => ({
    x: Math.random() * 100,
    y: Math.random() * 100,
