...
const socials = [
  {
    title: "github",
    username: "@ShreyasUrade1123",
    link: "https://github.com/ShreyasUrade1123",
    icon: RiGithubFill,
    color: "#6e5494",
  },
  {
    title: "telegram",
    username: "@shreyasurade",
    link: "https://t.me/shreyasurade",
    icon: RiTelegramFill,
    color: "#0077b5",
  },
  {
    title: "Instagram",
    username: "shreyas_urade",
    link: "https://www.instagram.com/shreyas_urade/",
    icon: RiInstagramFill,
    color: "#ff6600",
  },
  {
    title: "email",
    username: "shreyasurade4940@gmil.com",
    link: "mailto:shreyasurade4940@gmil.com",
    icon: RiMailFill,
    color: "#ea4335",
  },
];
...
export default function Socials() {
  ...
  const particleEffects = useClientParticles(10, (i) => ({
  ...
  const dustParticles = useClientParticles(20, (i) => ({
    left: 50 + (Math.random() - 0.5) * 40,
    top: 50 + (Math.random() - 0.5) * 40,
    xMovement: (Math.random() - 0.5) * 150 * (Math.random() > 0.5 ? 1 : -1),
    yMovement: (Math.random() - 0.5) * 150 * (Math.random() > 0.5 ? 1 : -1),
  ...
  return (
    ...
    >
          ...
          return (
            ...
            >
              ...
              >
                ...
                <AnimatePresence>
                  {isHovered && particleEffects.length > 0 && (
                    <>
                      {particleEffects.map((particle, i) => (
                        <motion.div
                          ...
                          style={{
                            ...
                            boxShadow: `0 0 ${particle.glowSize}px ${social.color}`
                          }}
                        />
                      ))}

                      {/* Cosmic dust particles */}
                      {dustParticles.length > 0 && dustParticles.map((particle, i) => (
                        <motion.div
                          key={`dust-${i}`}
                          className="absolute rounded-full z-0 pointer-events-none"
                          initial={{
      ...
      <div className="absolute inset-0 -z-20 overflow-hidden pointer-events-none">
        {bgParticles.length > 0 && bgParticles.map((particle, i) => (
          <motion.div
            key={`bg-particle-${i}`}
