...
export default function About() {
  ...
  // Optimize code particles with useClientParticles hook
  const codeParticles = useClientParticles(8, (i) => {
  ...
  // Generate particles for paragraph effects - one set that's reused
  const paragraphParticlesData = useClientParticles(15, (i) => {
