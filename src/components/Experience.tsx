...
const experience = [
  {
    ...
    position: "Full-Stack Problem Solver",
    date: "(May 2025 - July 2025)",
    description:
      "Built and deployed a full-stack Helpdesk Ticket Management System for 500+ employees, reducing average resolution time by 30% and manual queries by 40%.",
    link: "",
    color: "#f87171",
  },
  
  {
    ...
    position: "Pixel-Perfect Prototype Builder",
    date: "(April 2025 - May 2025)",
    description:
      "Redesigned 3 core gaming interfaces and created 25+ Figma prototypes, boosting user engagement by 20% and cutting setup-related support tickets by 40%.",
    link: "",
    color: "#fcd34d",
  }
];
    ...
    >
      ...
      <div className="mt-10 relative">
        ...
        {experience.map((exp, index) => {
          ...
          // Pre-calculate particle effects for better performance using useClientParticles
          const expParticles = useClientParticles(6, (i) => ({
            leftOffset: 50 + (Math.random() - 0.5) * 20,
            topOffset: 50 + (Math.random() - 0.5) * 20,
          ...
          const particleEffects = useMemo(() => {
            if (!isHovered || expParticles.length === 0) return null;

            return expParticles.map((p, i) => (
              <motion.div
                key={`particle-${i}`}
          ...
          }, [isHovered, exp.color, expParticles]);
