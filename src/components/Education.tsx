...
const edu = [
  ...
  description:
    "Juggling Data Structures, OOPS, and AI while building full-stack projects on the side.",
  link: "",
  color: "#60a5fa", // (You can change this color)
}
];
    ...
    >
      ...
      <div className="mt-10 relative">
        ...
        {edu.map((ed, index) => {
          ...
          const eduParticles = useClientParticles(4, (i) => ({
          ...
          const particleEffects = useMemo(() => {
            if (!isHovered || eduParticles.length === 0) return null;
          ...
          }, [isHovered, ed.color, eduParticles]);
